...
DedeFakeMouse = function() {
  this.x = $(window).width() / 2;
  this.y = $(window).height() / 2;

  this.s = document.createElement('div');
  this.s.setAttribute('id', 'dede-fake-mouse-pointer');
  this.s.setAttribute('style', 'position:absolute; left:' + this.x + 'px; top:' + this.y + 'px;');
  document.body.append(this.s);

  this.pointer = $('#dede-fake-mouse-pointer');
};

DedeFakeMouse.prototype.easeInOutQuart = function(t) { return t < 0.5 ? 8 * t * t * t * t : 1 - 8 * (--t) * t * t * t; };

DedeFakeMouse.prototype.click = function(callback) {
	var self = this;
...
DedeFakeMouse.prototype.moveTo = function(x, y, speed, callback) {
  var self = this;
...
DedeFakeMouse.prototype.clickTo = function(x, y, callback) {
	var self = this;

	this.moveTo(x, y, 2, function() { self.click(callback); });
};

DedeFakeMouse.prototype.clickOn = function(el, callback) {
	var self = this;
...
DedeFakeMouse.prototype.moveOn = function(el, callback) {
	var self = this;
